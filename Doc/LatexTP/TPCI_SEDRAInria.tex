...
$ cd /gitroot/tpcisedra/users/<yourforgelogin>.git/hooks
$ touch post-receive
...
\begin{lstlisting}[breaklines=true]
$ cp /gitroot/tpcisedra/users/bremond.git/hooks/post-receive /gitroot/tpcisedra/users/<yourforgelogin>.git/hooks
\end{lstlisting}
...
http://ci.inria.fr/tpcisedra/git/notifyCommit?url=https://scm.gforge.inria.fr/anonscm/git/tpcisedra/users/<yourforgelogin>.git
\end{lstlisting}
